      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="bg-[#2D6A4F] text-white rounded-2xl p-6 mb-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <h3 className="text-xl font-bold mb-2">FREE System Inspection</h3>
            ...
            <a
              ...
              className="bg-white text-[#2D6A4F] px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors whitespace-nowrap"
            >
